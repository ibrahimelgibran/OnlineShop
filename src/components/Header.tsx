...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 z-30 w-full border-t-8 border-blue-400 bg-white shadow-xl dark:bg-slate-900">
      <div className="container relative mx-auto flex items-center justify-between overflow-hidden px-5 py-3 md:py-3">
        <div className="rounded-md bg-blue-400 p-2 text-xl text-white">
        ...
        <div className="flex items-center gap-7">
            ...
            {menus.map((menu) => (
              <li key={menu.id}>
                <button
                  ...
                  className="menu flex w-full flex-col items-center transition hover:text-blue-400"
                >
          ...
          <motion.button
            ...
            className="rounded-sm bg-slate-100 p-2 text-xl text-blue-400 dark:bg-slate-800"
            initial={{ scale: 0 }}
